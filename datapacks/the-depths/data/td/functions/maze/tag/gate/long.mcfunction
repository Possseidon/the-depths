...
execute positioned ~0.5 ~ ~ if entity @e[tag=gate,distance=..0.1] run tag @s add gate_pos_x_1
execute positioned ~0.5 ~ ~1 if entity @e[tag=gate,distance=..0.1] run tag @s add gate_pos_x_2
...
execute positioned ~ ~ ~1.5 if entity @e[tag=gate,distance=..0.1] run tag @s add gate_pos_z
